        ...
        <div class="col-md-6">
          <div class="card mb-6 shadow-sm">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Lider de proyecto / Analista</p>
          ...
          <div class="card mb-6 shadow-sm">
            ...
            <div class="card-body">
             <p class="card-text"><strong>T.S.U en T.I.C Baeza Hernandez Ricardo.</strong></p>
              <p class="card-text">Desarrollador / Tester</p> 
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
      ...
      <div class="modal-body">
        <form>
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="recipient-name" disabled value ="T.S.U en T.I.C Rojas Corro Edson Eduardo">
          </div>
          <div class="form-group">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Recibe:</label>
            <input type="text" class="form-control" id="recipient-name" disabled placeholder="T.S.U en T.I.C Bravo Valencia Jesus">
          </div>
          <div class="form-group">
            <label for="message-text" class="col-form-label">Mensaje</label>
            <textarea class="form-control" id="message-text"></textarea>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Recibe:</label>
            <input type="text" class="form-control" id="recipient-name" disabled placeholder="T.S.U en T.I.C Mendez Ortega Jóse Antonio">
          </div>
          <div class="form-group">
            <label for="message-text" class="col-form-label">Mensaje</label>
            <textarea class="form-control" id="message-text"></textarea>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Recibe:</label>
            <input type="text" class="form-control" id="recipient-name" disabled placeholder="T.S.U en T.I.C Baeza Hernandez Ricardo">
          </div>
          <div class="form-group">
            <label for="message-text" class="col-form-label">Mensaje</label>
            <textarea class="form-control" id="message-text"></textarea>
