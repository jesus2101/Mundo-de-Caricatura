<div class="modal fade" id="opcion" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog  modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button"  class="btn btn-info" data-toggle="modal" data-dismiss="modal" data-target="#prueba2">Realizar quiz.</button>
      </div>
    </div>
  </div>
</div>
<div class="modal fade" id="prueba2" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Escoge tu caricatura y tus tipos de preuntas</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
        ...
        <form>
          <div class="form-row">
           <label for="inputState">Caricatura</label>
            ...
            $data = new Conexion();
            $data->conectar();
            $fila =$data->consultaArreglo($consulta);
...
<input type="submit" value="Realizar quiz."  class="btn btn-info"   >
</form>';
